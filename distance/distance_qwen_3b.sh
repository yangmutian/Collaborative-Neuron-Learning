...
# ================= Model =================
MODEL_NAME="/ssd/common/LLMs/Qwen2.5-3B-Instruct"
MODEL_TAG="$(basename "${MODEL_NAME%/}")"

# ================= Input data (from zero_ckpts) =================
BASE_DIR="./zero_ckpts/${DATASET}_${MODEL_TAG}_lr2e-8_usefreeze0/jsonl"

WRONG_JSONL="${BASE_DIR}/infer_wrong_ep14.jsonl"
CORRECT_JSONL="${BASE_DIR}/infer_correct_ep14.jsonl"
