...
# ================= Model =================
MODEL_NAME="/ssd/common/LLMs/Llama-3.2-1B-Instruct"
MODEL_TAG="$(basename "${MODEL_NAME%/}")"

# ================= Input data (from zero_ckpts) =================
BASE_DIR="./zero_ckpts/${DATASET}_${MODEL_TAG}_lr2e-9_usefreeze0/jsonl"

WRONG_JSONL="${BASE_DIR}/infer_wrong_ep18.jsonl"
CORRECT_JSONL="${BASE_DIR}/infer_correct_ep18.jsonl"
