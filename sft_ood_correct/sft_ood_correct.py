...
# ======================= train (wrong only, completely unchanged) =======================
    ...
    for ep in range(1, EPOCHS + 1):
        ...
        if USE_FREEZE:
            grad_c_ref_gpu = mean_grad_correct(
                model, tok, correct1_data, named_params,
                f"correct1 mean-grad ep{ep}"
            )
